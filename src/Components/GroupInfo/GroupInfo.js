  ...
  return (
    <div className='groupinfo-component groupinfo-pic'>
      <div className='blur-bg'>
        ...
        <p className='groupinfo-text groupinfo-paragraph'>Quint Advisors have that extensive overseas experience and knowledge from conducting and leading clandestine operations in every region of the world, often in hostile environments where the risk of exposure for US Government equities was extraordinary. 
        </p>
        <p className='groupinfo-text groupinfo-paragraph'>
        After their CIA service, Quint’s partners have all worked as senior business intelligence and security officials or consultants for major US and foreign corporations. In these positions, the partners have taken their extensive overseas experience and knowledge, developed over decades of sensitive work for the US government, and effectively applied it to a range of private sector interests in challenging locations. 
        </p>
        <p className='groupinfo-text groupinfo-paragraph'>
