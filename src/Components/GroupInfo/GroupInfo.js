...
const GroupInfo = () => {
  return (
    <div className='groupinfo-component'>
      ...
      After their CIA service, Quint’s five partners have all worked as senior business intelligence and security officials or consultants for major US and foreign corporations. In these positions, the partners have taken their extensive overseas experience and knowledge, developed over decades of sensitive work for the US government, and effectively applied it to a range of private sector interests in challenging locations. 
      </p>
